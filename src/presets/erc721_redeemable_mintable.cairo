...
#[starknet::interface]
pub trait IERC721RedeemableMintable<TState> {
...
#[starknet::interface]
pub trait IERC721RedeemableMintableMixin<TState> {
    // IERC721RedeemableMintable
    fn mint(ref self: TState, to: ContractAddress, token_id: u256);
    fn get_redeemables_contracts(self: @TState) -> Span<ContractAddress>;
    fn set_redeemables_contracts(ref self: TState, redeemables_contracts: Span<ContractAddress>);
    // IERC721Burnable
...
#[starknet::contract]
pub mod ERC721RedeemableMintable {
    use starknet::ContractAddress;
    ...
    #[abi(embed_v0)]
    impl ERC721RedeemableMintableImpl of super::IERC721RedeemableMintable<ContractState> {
